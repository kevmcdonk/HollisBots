...
namespace HollisBots.Controllers
{
    ...
    [RoutePrefix("/api/HubPersonMessages")]
    public class HubPersonMessagesController : ApiController
    {
        private readonly ILifetimeScope scope;

        public HubPersonMessagesController(ILifetimeScope scope)
        {
        ...
        public async Task<HttpResponseMessage> Post([FromBody]Activity activity, CancellationToken token)
        {
            try
            {
                if (activity.Type == ActivityTypes.Message)
                {
                    ...
                    {
                        await Conversation.SendAsync(activity, () => scope.Resolve<IPersonDialog>());
                    }
                }
                else
                {
            ...
            {
                System.Console.WriteLine("Hit an error in person controller: " + exp.Message + ";;;" + exp.StackTrace);
                throw exp;
            }
        }
